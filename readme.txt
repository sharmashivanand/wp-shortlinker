...
WP Shortlinker changes the internal links to use shortlinks instead of permalinks inside the WordPress editor.
...
1. DO NOT change the name of the `wp-shortlinker` folder.
1. Activate the plugin through the 'Plugins' menu in WordPress.

== Screenshots ==

1. WP Shortlinker: Inserting link via WordPress visual editor
